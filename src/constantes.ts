...
// Only ever shown in ConfigPannel for LIST_LAYOUT_DOCK, LIST_LAYOUT_STACK,
// LIST_LAYOUT_GRID and LIST_LAYOUT_SPLIT: false by default so an existing
// list saved before this option existed keeps showing its header.
